...
<html lang="en">
  <head>
    ...
    <title> Earn Money Online in Kenya | <?= $siteName ?> Global Services </title>
  ...
  <body>
    ...
    <div class="site-wrap">
      ...
      <header class="fbs__net-navbar navbar navbar-expand-lg dark" aria-label="freebootstrap.net navbar">
        <div class="container d-flex align-items-center justify-content-between">
          ...
          <div class="offcanvas offcanvas-start w-75" id="fbs__net-navbars" tabindex="-1" aria-labelledby="fbs__net-navbarsLabel">
            ...
            <div class="offcanvas-body align-items-lg-center">
              ...
              <ul class="navbar-nav nav me-auto ps-lg-5 mb-2 mb-lg-0">
                ...
                <li class="nav-item"><a class="nav-link scroll-link" href="#packages">Packages</a></li>
          ...
          <div class="ms-auto w-auto">
            ...
            <div class="header-social d-flex align-items-center gap-1"><a class="btn py-2 btn-white-outline" href="user/login.php">Log In</a>
              

            <div class="header-social d-flex align-items-center gap-1"><a class="btn btn-primary py-2" href="user/register.php">Get Started</a>
      ...
      <main>
              ...
              <div class="col-md-6 order-md-2">
                <div class="row justify-content-end">
                  <div class="col-md-11 mb-4 mb-md-0"><span class="subtitle text-uppercase mb-3" data-aos="fade-up" data-aos-delay="0">About us</span>
                    <h2 class="mb-4" data-aos="fade-up" data-aos-delay="100">Experience the future of making money by turning your free time into income.</h2>
                    <div data-aos="fade-up" data-aos-delay="200">
                      <p>We launched on 10th May 2025, and our mission is simple—empower people from all walks of life to earn online through legit, fun, and rewarding tasks.</p>
                      <p>Join thousands already earning daily from simple activities on their smartphones.</p>
                    </div>
                    ...
                    <ul class="d-flex flex-row flex-wrap list-unstyled gap-3 features" data-aos="fade-up" data-aos-delay="400">
                      ...
                      <li class="d-flex align-items-center gap-2"><span class="icon rounded-circle text-center"><i class="bi bi-check"></i></span><span class="text">User-Centric Earning </span></li>
                ...
                <div class="img-wrap position-relative"><img class="img-fluid rounded-4" src="assets/images/about_2-min.jpg" alt="FreeBootstrap.net image placeholder" data-aos="fade-up" data-aos-delay="0">
                  <div class="mission-statement p-4 rounded-4 d-flex gap-4" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div>
                      ...
                      <p class="fs-5 mb-0">Our mission is to empower every individuals by providing friendly money making mathods with guaranteed profits.</p>
                    </div>
                  </div>
                </div>
              </div>
                      ...
                      <div class="row"> 
                        <div class="col-lg-11">
                          <div class="h-100 flex-column justify-content-between d-flex">
                            ...
                            <div class="align-self-start"><a class="glightbox btn btn-play d-inline-flex align-items-center gap-2" href="https://www.youtube.com/shorts/YgXb9zDVm3o" data-gallery="video"><i class="bi bi-play-fill"></i> Watch the Video</a></div>
                          </div>
                        </div>
                      </div>
                    </div>
                        ...
                        <div class="col-lg-11">
                          <div class="row">
                            ...
                            <div class="col-sm-6" data-aos="fade-up" data-aos-delay="100">
                              ...
                              <h3 class="fs-6 fw-bold mb-3">Multiple Earning Options</h3>
                              <p>From referrals to trivia, ads, and more.</p>
                            </div>
                            <div class="col-sm-6" data-aos="fade-up" data-aos-delay="200">
                              <div class="icon text-center mb-4"><i class="bi bi-headset fs-4"></i></div>
                              <h3 class="fs-6 fw-bold mb-3">Cashback Guarantee</h3>
                              <p>Get back Ksh 1000 instantly on activation.</p>
                            </div>
                            <div class="col-sm-6" data-aos="fade-up" data-aos-delay="300">
                              <div class="icon text-center mb-4"><i class="bi bi-shield-lock fs-4"></i></div>
                              <h3 class="fs-6 fw-bold mb-3">Friendly Community</h3>
                              <p>Weekly bonuses, team rewards & rankings.</p>
                            </div>
                          </div>
                        </div>
                      </div>
        ...
        <!-- ======= Packages =======-->
        <section class="section pricing__v2" id="packages">
          <div class="container">
            <div class="row mb-5">
            ...
            <div class="row g-md-5">
              <div class="col-md-6 col-lg-3">
                <div class="step-card text-center h-100 d-flex flex-column justify-content-start position-relative" data-aos="fade-up" data-aos-delay="0">
                  ...
                  <div>
                    ...
                    <p>Create your account with email, phone and username.</p>
                  </div>
                </div>
              </div>
              <div class="col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="600">
                <div class="step-card reverse text-center h-100 d-flex flex-column justify-content-start position-relative">
                  ...
                  <p>Choose your package and pay activation fee.</p>
                </div>
              </div>
              <div class="col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="1200">
                <div class="step-card text-center h-100 d-flex flex-column justify-content-start position-relative">
                  ...
                  <p> Start completing tasks like watching videos or answering trivia.</p>
                </div>
              </div>
              <div class="col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="1800">
                <div class="step-card last text-center h-100 d-flex flex-column justify-content-start position-relative"><span class="step-number rounded-circle text-center fw-bold mb-5 mx-auto">4</span>
                  <div>
                    <h3 class="fs-5 mb-4">Invite and Grow</h3>
                    <p>Share your referral link, build a team, and unlock bonuses.</p>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="d-flex flex-wrap content rounded-4" data-aos="fade-up" data-aos-delay="0">
                  ...
                  <div class="col-12 col-sm-6 col-md-4 mb-4 mb-md-0 text-center" data-aos="fade-up" data-aos-delay="300">
                    <div class="stat-item">
                      ...
                      <p class="mb-0">Earning Potential</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section class="section services__v3" id="services">
          <div class="container">
            <div class="row mb-5">
              <div class="col-md-8 mx-auto text-center"><span class="subtitle text-uppercase mb-3" data-aos="fade-up" data-aos-delay="0">Ways To Earn</span>
                <h2 class="mb-3" data-aos="fade-up" data-aos-delay="100">Meet your Financial Goals through our earning opportunities</h2>
              </div>
            </div>
            <div class="row g-4">
              <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="0">
                <div class="service-card p-4 rounded-4 h-100 d-flex flex-column justify-content-between gap-5">
                  <div><span class="icon mb-4">
                    ...
                    <h3 class="fs-5 mb-3">Affiliate Marketing</h3>
                    <p class="mb-4">This program will allow you to earn over KSH.2000/ =  per day by inviting/recruiting friends via your link</p>
              ...
              <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="300">
                <div class="service-card p-4 rounded-4 h-100 d-flex flex-column justify-content-between gap-5">
                  <div><span class="icon mb-4">
                    ...
                    <h3 class="fs-5 mb-3">Promotional Youtube Videos</h3>
                    <p class="mb-4">Watch various educative YouTube videos which will be uploaded on our platform  and get paid per video.</p>
                  </div><a class="special-link d-inline-flex gap-2 align-items-center text-decoration-none" href="#"><span class="icons"><i class="icon-1 bi bi-arrow-right-short"></i><i class="icon-2 bi bi-arrow-right-short"> </i></span><span>Read more</span></a>
                </div>
              </div>
              <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="400">
                <div class="service-card p-4 rounded-4 h-100 d-flex flex-column justify-content-between gap-5">
                  <div><span class="icon mb-4">
                    ...
                    <h3 class="fs-5 mb-3">Promotional Tiktok Videos</h3>
                    <p class="mb-4">Funny and educative TikTok videos will be posted on the dashbord and get paid.</p>
                  </div><a class="special-link d-inline-flex gap-2 align-items-center text-decoration-none" href="#"><span class="icons"><i class="icon-1 bi bi-arrow-right-short"></i><i class="icon-2 bi bi-arrow-right-short"> </i></span><span>Read more</span></a>
                </div>
              </div>
              <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="500">
                <div class="service-card p-4 rounded-4 h-100 d-flex flex-column justify-content-between gap-5">
                  <div><span class="icon mb-4">
                    ...
                    <h3 class="fs-5 mb-3">Trivia Questions</h3>
                    <p class="mb-4">Simple questions concerning various topics will be uploaded in your dashbord and answered when a correctly get paid.</p>
                  </div><a class="special-link d-inline-flex gap-2 align-items-center text-decoration-none" href="#"><span class="icons"><i class="icon-1 bi bi-arrow-right-short"></i><i class="icon-2 bi bi-arrow-right-short"> </i></span><span>Read more</span></a>
                </div>
              </div>
              <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="600">
                <div class="service-card p-4 rounded-4 h-100 d-flex flex-column justify-content-between gap-5">
                  <div><span class="icon mb-4">
                    ...
                    <h3 class="fs-5 mb-3">Advance Forex Signals</h3>
                    <p class="mb-4">Forex market is  global Marketplace for exchanging national currencies. We give basic Forex classes for beginners and build your confidence in trading Forex, remember you can also be given a chance to trade with both demo & live accounts</p>
                  </div><a class="special-link d-inline-flex gap-2 align-items-center text-decoration-none" href="#"><span class="icons"><i class="icon-1 bi bi-arrow-right-short"></i><i class="icon-2 bi bi-arrow-right-short"> </i></span><span>Read more</span></a>
                </div>
              </div>
            </div>
            ...
            <div class="row g-4" data-masonry="{&quot;percentPosition&quot;: true }">
              <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="0">
                <div class="testimonial rounded-4 p-4">
                  <blockquote class="mb-3">
                     &ldquo;
                    his platform has completely changed my weekends. Watching videos and answering trivia is actually fun—and I’m earning!
                    &rdquo;
                  </blockquote>
                  <div class="testimonial-author d-flex gap-3 align-items-center">
                    ...
                    <div class="lh-base"><strong class="d-block">Diana K.</strong><span>UoN Student</span></div>
                  </div>
                </div>
              </div>
              <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="100">
                <div class="testimonial rounded-4 p-4">
                  <blockquote class="mb-3">
                     &ldquo;
                    I was skeptical, but Ksh 1300 was worth it. I’ve already earned back more than I spent in a few days.
                    &rdquo;
                  </blockquote>
                  <div class="testimonial-author d-flex gap-3 align-items-center">
                    ...
                    <div class="lh-base"><strong class="d-block">Brian O.</strong><span>Form 4 Graduate</span></div>
                  </div>
                </div>
              </div>
              <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="200">
                <div class="testimonial rounded-4 p-4">
                  <blockquote class="mb-3">
                     &ldquo;
                    It’s easy to refer people once they see how it works. The bonuses and weekly rewards keep me motivated!
                    &rdquo;
                  </blockquote>
                  <div class="testimonial-author d-flex gap-3 align-items-center">
                    ...
                    <div class="lh-base"><strong class="d-block">Cathy M.</strong><span>Stay-at-home Mom</span></div>
                  </div>
                </div>
              </div>
                 </div>
          ...
          <div class="container">
            <div class="row mb-4">
              <div class="col-md-6 col-lg-7 mx-auto text-center"><span class="subtitle text-uppercase mb-3" data-aos="fade-up" data-aos-delay="0">FAQ</span>
                ...
                <p data-aos="fade-up" data-aos-delay="100">Utilize our platfor to earn money and change you life. Once done so, effortlessly share your experience.</p>
              </div>
            </div>
            <div class="row">
                  ...
                  <div class="accordion custom-accordion" id="accordionPanelsStayOpenExample">
                    <div class="accordion-item">
                      <h2 class="accordion-header">
                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseOne" aria-expanded="true" aria-controls="panelsStayOpen-collapseOne"> How do I start Earning? </button>
                      </h2>
                      <div class="accordion-collapse collapse show" id="panelsStayOpen-collapseOne">
                        <div class="accordion-body">Simply register for a free account, choose a package, and begin viewing ads to earn. The more ads you view, the more you earn!</div>
                      </div>
                    </div>
                    <div class="accordion-item">
                      <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseTwo" aria-expanded="false" aria-controls="panelsStayOpen-collapseTwo"> What do I need to get started? </button>
                      </h2>
                      <div class="accordion-collapse collapse" id="panelsStayOpen-collapseTwo">
                        <div class="accordion-body">Just a phone, email, phone number, and a one-time activation fee of Ksh 1300.</div>
                      </div>
                    </div>
                    <div class="accordion-item">
                      <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseThree" aria-expanded="false" aria-controls="panelsStayOpen-collapseThree"> How do I earn? </button>
                      </h2>
                      <div class="accordion-collapse collapse" id="panelsStayOpen-collapseThree">
                        <div class="accordion-body">Through watching videos, answering trivia, referring friends, and more depending on your package.</div>
                      </div>
                    </div>
                    <div class="accordion-item">
                      <h2 class="accordion-header">
                    ...
                    <div class="accordion-item">
                      <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseFive" aria-expanded="false" aria-controls="panelsStayOpen-collapseFive"> Is this legit? </button>
                      </h2>
                      <div class="accordion-collapse collapse" id="panelsStayOpen-collapseFive">
                        <div class="accordion-body">Absolutely. Our systems are tested and payouts are fast and verified.</div>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div class="container">
            <div class="row mb-5">
              <div class="col-md-6 col-lg-7 mx-auto text-center"><span class="subtitle text-uppercase mb-3" data-aos="fade-up" data-aos-delay="0">Contact</span>
                ...
                <p data-aos="fade-up" data-aos-delay="100">Any queries, Concerns and Compilments? Reach out to us and we will get back to you.</p>
              </div>
            </div>
            <div class="row">
              <div class="col-md-6">
                <div class="d-flex gap-5 flex-column">
                  <div class="d-flex align-items-start gap-3" data-aos="fade-up" data-aos-delay="0">
                    <div class="icon d-block"><i class="bi bi-telephone"></i></div><span> <span class="d-block">Phone</span><strong><?= $sitePhone ?></strong></span>
                  </div>
                  <div class="d-flex align-items-start gap-3" data-aos="fade-up" data-aos-delay="100">
                    <div class="icon d-block"><i class="bi bi-send"></i></div><span> <span class="d-block">Email</span><strong><?= $siteEmail ?></strong></span>
                  </div>
                  <div class="d-flex align-items-start gap-3" data-aos="fade-up" data-aos-delay="200">
                    <div class="icon d-block"><i class="bi bi-geo-alt"></i></div><span> <span class="d-block">Address</span>
                      <address class="fw-bold"><?= nl2br($siteAddress) ?></address></span>
                  </div>
                </div>
              </div>
              <div class="col-md-6">
              ...
              <div class="col-md-7">
                <div class="row g-2">
                  ...
                  <div class="col-md-6 col-lg-4 mb-4 mb-lg-0 quick-contact">
                    ...
                    <p class="d-flex mb-3"><i class="bi bi-geo-alt-fill me-3"></i><span><?= nl2br($siteAddress) ?></span></p><a class="d-flex mb-3" href="mailto:<?= $siteEmail ?>"><i class="bi bi-envelope-fill me-3"></i><span><?= $siteEmail ?></span></a><a class="d-flex mb-3" href="tel://<?= $sitePhone ?>"><i class="bi bi-telephone-fill me-3"></i><span><?= $sitePhone ?></span></a>
                  </div>
            ...
            <div class="row credits pt-3">
              <div class="col-xl-8 text-center text-xl-start mb-3 mb-xl-0">
                ...
                <script>document.write(new Date().getFullYear());</script> Copyright. 
                 All rights reserved. Website by <a href="https://freebootstrap.net">TCMedia</a>
              </div>
          </div>
        </footer>
        <!-- End Footer-->
